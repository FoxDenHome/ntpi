...
#docker build -t ghcr.io/foxdenhome/raspi-alpine-builder ../../raspi-alpine-builder
...
docker run --rm -it --entrypoint=/bin/sh -v $PWD/testimg:/testimg ghcr.io/foxdenhome/raspi-alpine-builder -c "cp /uboot/u-boot_rpi-64.bin /testimg/u-boot_rpi-64.bin"
